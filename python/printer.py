...
class LegoPrinter:
    ...
    def calibrate(self):
        ...
        Sound.speak('Kalibrovka pozicii motorov').wait()
        ...
        Sound.speak('Kalibrovka pozicii motorov zakonchena').wait()
    ...
    def feed_paper(self):
        ...
        while waiting_paper:
            ...
            if timer > max_time:
                waiting_paper = False
                print ("Пользователь не подал бумагу вовремя... Закрытие...")
                self.is_busy = False
                return
        ...
        self.is_busy = False
        Sound.speak('Bumaga podana').wait()
